...
bool getRayIntersectionPlanePoint(vec3 ray_start, glm::vec3 ray_dir, vec3 plane_point, glm::vec3 plane_norm, vec3& out_point){
...
//cube clipping based on Sutherland-Hodgman algorithm
std::vector<double[]> subject,clipper,result;
GLfloat vertices[8][3] = {
        // "Front" vertices
        {-2.0f, -2.0f,  2.0f}, {400.0f, -400.0f,  400.0f}, {400.0f,  400.0f,  400.0f}, {-400.0f,  400.0f,  400.0f},
        // "Back" vertices
